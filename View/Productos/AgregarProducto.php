                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="Imagen" placeholder="ej: productos/iphone14.jpg">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>&nbsp;</label>
                                <button type="submit" name="btnAgregarProducto" class="btn btn-primary btn-block">
                                    Guardar producto
                                </button>
                            </div>
                        </div>
